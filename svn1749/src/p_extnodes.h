...
extern mapformat_t P_CheckMapFormat ( lumpnum_t lumpnum );

extern void P_LoadSegs_DeePBSP ( lumpnum_t lump );
extern void P_LoadSubsectors_DeePBSP ( lumpnum_t lump );
extern void P_LoadNodes_DeePBSP ( lumpnum_t lump );
extern void P_LoadNodes_ZDBSP ( lumpnum_t lump, boolean compressed );
