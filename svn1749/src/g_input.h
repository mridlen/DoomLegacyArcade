...
// The two "pair" entries are what the scheme swaps: under "Tank"
...
enum {
    ...
    CK_nextweapon,
    CK_prevweapon,
    CK_pair_a_left,     // turn left  under "Tank", strafe under WASD
    CK_pair_a_right,
    CK_pair_b_left,     // strafe left under "Tank", turn under WASD
    CK_pair_b_right,
    CK_NUMKEYS
};
