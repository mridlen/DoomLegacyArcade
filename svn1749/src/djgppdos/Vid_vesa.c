...
//-----------------------------------------------------------------------------
//
// $Id: Vid_vesa.c 1650 2023-10-25 02:25:41Z wesleyjohnson $
//
...
// seul le mode 320x200x256c standard VGA est supporté sans le VESA.
// ce mode est le mode numéro 0 dans la liste.
typedef struct
{
